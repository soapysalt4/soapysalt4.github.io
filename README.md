...
Please read the license before copying any software on this repository!
...
4. This repository is intended for deployment on a **static platform**.  
   Node.js compatibility is **not required**.
